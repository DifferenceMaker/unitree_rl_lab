...
def main():
    ...
    try:
        ...
        print(f"[INFO] Falling back to single-input torch.onnx.export (input name='obs')")
        import torch
        ...
        # CRITICAL: input name MUST be "obs" — that's the default group name the C++
        # ObservationManager uses for flat-structured deploy.yaml observations.
        # See deploy/include/isaaclab/manager/observation_manager.h _prapare_terms()
        torch.onnx.export(
